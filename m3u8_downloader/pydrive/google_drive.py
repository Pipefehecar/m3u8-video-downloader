...
directorio_credenciales = f'{sys.path[0]}\\pydrive\\credentials_module.json'
print(Fore.GREEN + directorio_credenciales)
...
def crear_archivo_texto(nombre_archivo,contenido,id_folder='1eyzPAIDv409dc3u7zheQre6WtLOq2cub'):
    credenciales = login()
...
def subir_archivo(title, ruta_archivo,id_folder='1eyzPAIDv409dc3u7zheQre6WtLOq2cub'):
    credenciales = login()
    print(Fore.BLUE + 'Conectando con google drive...')
    ...
    archivo.Upload()
    print(Fore.BLUE + 'Video cargado con exito...')
...
if __name__ == "__main__":
    ...
    # crear_archivo_texto('HolaDrive.txt','Hey MoonCoders')
    ruta_archivo = 'C:\\Users\\luisf\\Desktop\\code\\pyscripts\\video_downloader\\videos\\vide.mp4'
